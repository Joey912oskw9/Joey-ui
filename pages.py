...
<div class="wrap">
  <div class="card">
    <div class="brand">
      ...
      <div><div class="brand-name">codebox</div><div class="brand-sub">VaslZone Gateway · v9.3</div></div>
    </div>
    <h1>ورود به پنل</h1>
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">codebox</div><div class="logo-sub">VaslZone Gateway · v9.3</div></div>
  </div>
  <div class="nav-wrap">
