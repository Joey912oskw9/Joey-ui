...
<div class="wrap">
  <div class="card">
    <div class="brand">
      ...
      <div><div class="brand-name">VaslZone</div><div class="brand-sub">RVG Gateway · v9.2</div></div>
    </div>
    <h1>ورود به پنل</h1>
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">VaslZone</div><div class="logo-sub">RVG Gateway · v9.2</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">VaslZone RVG Gateway v9.2 · Railway · 2025</span>
