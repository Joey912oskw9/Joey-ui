...
:root{{--bg:#050504;--bg2:#0a0a08;--bg3:#11110d;--card:#0d0d0a;--card2:#141410;--card3:#1a1a15;--border:rgba(255,215,0,0.08);--border2:rgba(255,215,0,0.30);--accent:#FFD700;--accent2:#FFC107;--accent3:#FFE44D;--text:#F5F5DC;--text2:#C8C8A0;--text3:#6B6B40;--green:#66BB6A;--green-bg:rgba(102,187,106,0.10);--red:#EF5350;--red-bg:rgba(239,83,80,0.10);--amber:#FFD700;--amber-bg:rgba(255,215,0,0.10);--blue:#FFD700;--blue-bg:rgba(255,215,0,0.08);--shadow:0 8px 32px rgba(0,0,0,0.6);--radius:16px}}
...
.ch-link{{display:inline-flex;align-items:center;gap:6px;font-size:11px;color:var(--accent);text-decoration:none;font-weight:600;margin-top:8px;padding:5px 14px;border-radius:20px;background:var(--amber-bg);border:1px solid rgba(255,215,0,0.12);transition:.2s}}
...
function render(d){{
  ...
  for(let i=0;i<d.links.length;i++){{
    ...
    const bc=pct>90?"var(--red)":pct>70?"var(--accent)":pct>0?"var(--green)":"var(--text3)";
